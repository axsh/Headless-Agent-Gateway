...
func TestHandleMessagesBifrostStream_RetryOpenThenSuccess(t *testing.T) {
	...
	handleMessagesBifrostStream(ctx, rec, context.Background(), nil, &bifrostSchemas.BifrostResponsesRequest{
...
func TestHandleMessagesBifrostStream_RetryLeadingErrorChunk(t *testing.T) {
	orig := openBifrostResponsesStream
	defer func() { openBifrostResponsesStream = orig }()
...
func TestHandleMessagesBifrostStream_NonRetryableNoRetry(t *testing.T) {
	orig := openBifrostResponsesStream
	defer func() { openBifrostResponsesStream = orig }()
...
func TestHandleMessagesBifrostStream_ZeroRetryConfigStillRetries(t *testing.T) {
	orig := openBifrostResponsesStream
	defer func() { openBifrostResponsesStream = orig }()
	...
	handleMessagesBifrostStream(ctx, rec, ctxTimeout, nil, &bifrostSchemas.BifrostResponsesRequest{
		Model: "claude-sonnet-4-20250514",
	}, "claude-sonnet-4-20250514")
